...
var language_toggle_controller_default = class extends Controller {
...
// app/javascript/controllers/kpi_controller.js
var kpi_controller_default = class extends Controller {
...
// app/javascript/controllers/lean_canvas_controller.js
var lean_canvas_controller_default = class extends Controller {
...
---
Generated with Pitoa - ${(/* @__PURE__ */ new Date()).toLocaleDateString()}
`;
  }
...
// app/javascript/controllers/wizard_progress_controller.js
var wizard_progress_controller_default = class extends Controller {
  ...
  celebrateIfAllCompleted(actionId) {
    ...
    if (completedActions.length === totalActions && totalActions > 0) {
      setTimeout(() => {
        if (confirm("\u{1F389} Amazing! You've completed all actions for this framework. Ready to move to the next one?")) {
  ...
  exportProgress(event) {
    ...
    const report = {
      ...
      completedActions,
      completedTools,
      progressPercentage: this.hasActionItemTarget ? Math.round(completedActions.length / this.actionItemTargets.length * 100) : 0
    };
...
application.register("language-toggle", language_toggle_controller_default);
application.register("kpi", kpi_controller_default);
application.register("wizard", wizard_controller_default);
application.register("lean-canvas", lean_canvas_controller_default);
application.register("wizard-progress", wizard_progress_controller_default);
